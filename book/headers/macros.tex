...
%% \newcommand{\texteditor}[1]{
%% \begin{mdframed}
%% \begin{programcode}{Text editor}%
...
%% \lstinputlisting[#1]{#2}}}
%% \end{python}
% path for pythonexternal is relative
% to book.tex.  Source is assumed to be
% included in ./chapters/chp-num/src
% so you use this command as 
% \pyfile{chp3}{filename} etc

% MER: These Python commands depend on \usepackage{pythonhighlight}

\newcommand\pyfile[2]{
  \inputpython{./chapters/#1/src/#2}{0}{1000}
}

\newcommand\pythonsnippet[4]{
  \inputpython{./chapters/#1/src/#2}{#3}{#4}
}
...
%\newcommand{\pythoninline[1]}{{#1}}


% ---------------------------------

%% \lstdefinestyle{pyStyle2}{
%%     language=python,
%%     basicstyle=\ttfamily ,       
%% 	keywordstyle=\ttb\color{deepblue},
%%     emph={class},
