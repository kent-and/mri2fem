...
\item
  ...
  the \emp{recon-all} process and this is why we can use Freeview to see the 
...
section, these labels can be viewed by opening a subject's \emp{aseg.mgz} file 
...
%include hundreds of larger and smaller regions
\footnote{{\freesurfer}'s \emp{recon-all} parcellates a brain into the regions 
