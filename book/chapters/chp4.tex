...
Chapter~\ref{sec:chp3:improved-volume-meshing}\footnote{We leave the
  ...
  \emp{lh.pial.stl} and \emp{lh.white.stl}, respectively, in the following.  Note
...
map. The string \pythoninline{"10"} referring to the list
...
\pythoninline{"11"} is interpreted as 'inside pial' and 'inside white'
and thus represents the region inside the gray--white surface, that
is, the white matter. We will discuss \pythoninline{SubdomainMap}
