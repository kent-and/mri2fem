...
segmentation, onto the brain mesh.  It is important that we are using the 
\emp{wmparc.gz} \freesurfer{} parcellation file that was generated from the 
same set of original T1 images that were used to create the mesh onto which 
we are mapping these labels.   
%
...
%data.  
Mesh functions can be associated with cells, faces, edges, or vertices. Here, 
we aim to identify the parcellation region for each cell in the brain mesh and will thus
