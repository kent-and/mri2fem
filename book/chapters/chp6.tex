...
distribution of gadobutrol in the gray matter regions and hippocampus
are affected much more than in the white matter regions. This result is
expected since both the gray matter and hippocampus are
...
that the upper regions, that is, the superior frontal gray and white matter
...
\begin{figure}%[t]
  ...
  \caption{Average concentration of gadobutrol (y-axis, arbitrary
    ...
    matter), 1028 (superior frontal gray matter), and 3028
