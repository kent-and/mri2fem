...
directory\footnote{Note that one can avoid the automatic addition of
...
\pythoninline{resolution} parameter default in this script is 16.  Small changes in this 
...
\footnote{The point we consider here does not represent a point of any 
particular significance; $p$ was selected simply as an arbitrary point in the 
