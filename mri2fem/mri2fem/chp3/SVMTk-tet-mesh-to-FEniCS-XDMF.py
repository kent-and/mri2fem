...
def convert(meshFile, fileFormatAccess="medit:ref"):
    ...
    print("---> Saving *tetrahedral* mesh conversion (for triangular meshes, use SVMTk-tri-mesh-to-FEniCS-XDMF.py)")
    meshio.write(f"{meshFile[:p]}.xdmf", tetra_mesh)
...
if __name__ == "__main__":
    ...
    if p != -1:
        ...
        print("Example: python3 SVMTk-tet-mesh-to-FEniCS-XDMF.py myfile.mesh")
